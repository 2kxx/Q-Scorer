...
class PairDataset(Dataset):
    ...
    def get_one_item(self, idx_dataset, idx_sample) -> Dict[str, torch.Tensor]:
        ...
        # default task_type: "score"
        data_dict["task_type"] = sources_org[0].get("task_type", "score")
        data_dict["gt_score_norm"] = sources_org[0].get("gt_score_norm", -10000)
...
class DataCollatorForPairDataset(object):
    ...
    def __call__(self, instances: Sequence[Dict]) -> Dict[str, torch.Tensor]:
        ...
        batch["gt_scores"] = torch.tensor([instance["gt_score_norm"] for instance in instances])
